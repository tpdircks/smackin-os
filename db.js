...
window.DB = (function () {
  ...
  return {
    ...
    floorSlots: (seed && seed.floorSlots) ? seed.floorSlots : () => [],
    floor4Slots: (seed && seed.floor4Slots) ? seed.floor4Slots : () => [],
    floor15Slots: (seed && seed.floor15Slots) ? seed.floor15Slots : () => [],
    floorLabel: (seed && seed.floorLabel) ? seed.floorLabel : () => "",
